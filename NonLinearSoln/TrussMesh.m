...
% This file defines the geometry for the TRUSS2D3D code. 
% User must input the nodal coordinates and the connectivity array.
...
% number of nodes per element. define this variable since it will be used 
% for determining the dimensions of future arrays.
nnpe=2;   
        
%% Define the coordinates of the nodes (DEFINE THIS FOR EACH PROBLEM)
